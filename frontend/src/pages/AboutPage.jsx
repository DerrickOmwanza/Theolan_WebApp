...
const VALUES = [
  {
    ...
    description: 'Every cut, weld, and finish meets international standards. We use computer-aided design and precision machinery to ensure millimetre accuracy.',
  },
  {
  ...
  },
  {
    ...
    description: 'Our project management team ensures your installation is completed on schedule, with transparent progress tracking at every stage.',
  },
  {
    title: 'Expert Team',
    description: 'Our technicians are certified professionals with years of experience in architectural aluminium fabrication and installation.',
  },
];
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {STATS.map(stat => (
              <div key={stat.label} className="text-center">
                <p className="text-3xl md:text-4xl font-heading font-bold text-gold-400">{stat.value}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-silver-300 leading-relaxed">
              ...
              <p>
                Today, we combine traditional craftsmanship with modern technology — including computer-aided design, precision CNC machinery, and digital project management — to deliver results that exceed expectations.
              </p>
            </div>
          </div>
      ...
      <section className="bg-charcoal-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-heading font-bold text-warmwhite text-center mb-12">What Sets Us Apart</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {VALUES.map(v => (
              <div key={v.title} className="card hover:border-cobalt/50 transition-colors">
                <h3 className="text-lg font-heading font-semibold text-cobalt-300 mb-2">{v.title}</h3>
                <p className="text-sm text-silver-400 leading-relaxed">{v.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Certifications */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <h2 className="text-3xl font-heading font-bold text-warmwhite text-center mb-12">Certifications & Compliance</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
          {CERTIFICATIONS.map(cert => (
            <div key={cert} className="flex items-start gap-3 p-4 rounded-lg bg-charcoal-700 border border-charcoal-600">
