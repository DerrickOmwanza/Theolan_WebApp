  ...
  return (
    <div className="flex min-h-screen bg-charcoal-800">
      ...
      <div className="flex-1 flex flex-col">
        {/* Top bar */}
        <header className="h-16 bg-charcoal-900/50 border-b border-charcoal-600 flex items-center px-4 lg:px-8">
          <button
            onClick={() => setSidebarOpen(true)}
            className="lg:hidden p-2 text-silver-400 hover:text-warmwhite mr-4"
          >
            <svg
              className="w-6 h-6"
              fill="none"
